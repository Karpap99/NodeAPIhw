...
app.put('/student/:id',async(req,res)=>{
    try{
        ...
        if(req.body["lastName"] != undefined) updateReq = {...updateReq, lastName: req.body["lastName"] };
        if(req.body["group"] != undefined) updateReq = {...updateReq, group: req.body["group"] }; 
        if(req.body["rate"] != undefined) updateReq = {...updateReq, rate: req.body["rate"] }; 
